      ...
      <div class="container">
        ...
        <div class="cardanimate" style="--i: 5">
          <div class="card card-2">
            <div class="card-header">
              <img src="src/img/cinekz.png" class="card-img" />
            </div>
    
            <div class="card-body">
    
              <h2 class="card-titulo">CineKaizoku</h2>
              <p class="card-texto">
                CineKaizoku, a project that simulates a movie and series streaming platform inspired by the giant Netflix! Developed with the powerful duo of PHP and MySQL for the back-end, CineKaizoku offers an immersive experience.. 
              </p>
            ...
            <div class="card-footer">
              ...
              <a href="https://github.com/RiquelmiDev/CineKaizoku">View more</a>
        ...
        <div class="cardanimate" style="--i: 6">
          ...
          <div class="card card-3">
            <div class="card-header">
              <img src="src/img/mart-port.png" class="card-img" />
            </div>
    
            <div class="card-body">
    
              <h2 class="card-titulo">Mart Chatbot</h2>
              <p class="card-texto">
                MART (My Friend Solves Everything, "Meu Amigo Resolve Tudo" in pt-br) is a fun and clever chatbot, built using Google's powerful Gemini API. Developed during the Alura + Google event. 
              </p>
            ...
            <div class="card-footer">
              ...
              <a href="https://github.com/RiquelmiDev/MartChatBot">View more</a>
